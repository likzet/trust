function PayoffsUI(config){
	...
	dom.appendChild(_makeLabel("label_cheat", {x:230, y:90, rotation:45, align:"center", color:"#cccccc"}));
	dom.appendChild(_makeLabel("label_cheat", {x:-17, y:89, rotation:-45, align:"center", color:"#cccccc"}));
